...
use DB;
class Manage_newsletter extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            ...
            'session'       => $session,
            'module'        => 'Newsletter',
            'controller'    => 'manage_newsletter',
            'table_name'    => 'sms_newsletter',
            'primary_key'   => 'id'
        );
    }
    ...
    public function download_csv() 
    {
        ...
        $data['rows']               = $this->data['model']->find_data('sms_newsletter', 'array', ['published!=' => 3], '', '', '', $order_by);
        return view('admin/maincontents/newsletter/download-csv',$data);
    }
}
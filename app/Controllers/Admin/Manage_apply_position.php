...
class Manage_apply_position extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            'model'         => $model,
            'session'       => $session,
            'module'        => 'Apply Position',
            'controller'    => 'manage_apply_position',
            'table_name'    => 'sms_apply_positions',
            'primary_key'   => 'id'
        );
    }
    ...
    public function add()
    {
        ...
        $page_name                  = 'apply-position/add-edit';        
        $data['row'] = [];
        if($this->request->getMethod() == 'post') {
            $postData   = array(

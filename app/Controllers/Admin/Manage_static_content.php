...
class Manage_static_content extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            ...
            'controller'    => 'manage_static_content',
            'table_name'    => 'sms_static_content',
    ...
    public function add()
    {
        ...
        $page_name                  = 'static-content/add-edit';        
        $data['row'] = [];

...
use DB;
class Manage_package_category extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            ...
            'controller'    => 'manage_package_category',
    ...
    public function index() 
    {
        ...
        $page_name                  = 'package-category/list';        
    ...
    public function add()
    {
        ...
        $page_name                  = 'package-category/add-edit';        
        $data['row'] = [];
        if($this->request->getMethod() == 'post') {
            $postData   = array(

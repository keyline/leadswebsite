...
class Manage_company extends BaseController {
	...
	public function __construct()
    {
        ...
        $this->data = array(
            ...
            'session'       => $session,
            'module'        => 'Company',
            'controller'    => 'manage_company',
            'table_name'    => 'sms_company',
            'primary_key'   => 'id'
        );
    }
    ...
    public function add()
    {
        ...
        if($this->request->getMethod() == 'post') {            
            $slug = strtolower($this->data['model']->clean($this->request->getPost('name')));
            $postData   = array(

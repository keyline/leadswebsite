<div class="navbar-wrapper">
    <div class="navbar-content scroll-div ">
        <ul class="nav pcoded-inner-navbar ">
            ...
            <!-- Popup Settings -->
            <li class="nav-item"><a href="<?php echo base_url('admin/Pop_up_setting'); ?>" class="nav-link "><span class="pcoded-micon"><i class="fa fa-bell"></i></span><span class="pcoded-mtext">Pop-up Setting</span></a></li>
            <!-- Home Page Video Settings -->
            <li class="nav-item"><a href="<?php echo base_url('admin/Home_page_video_settings'); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-video"></i></span><span class="pcoded-mtext">About Video setting</span></a></li>
            <!-- Products Video Settings -->
            <li class="nav-item"><a href="<?php echo base_url('admin/Products_video_setting'); ?>" class="nav-link "><span class="pcoded-micon"><i class="feather icon-video"></i></span><span class="pcoded-mtext">Products Video setting</span></a></li>

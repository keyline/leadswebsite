                        ...
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td>
                                        <?php if($row->brochure_pdf!='') { ?>
                                            <a href="<?= base_url('material/front/assets/inc/MitraSK_CorporatePresentation_15092022.pdf') ?>" target="blank" class="fas fa-eye" style='color:blue'> VIEW PRESENTATION</a>
                                        <?php } ?>                                        
                                    </td>
                                    <td>

                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $category          = $moduleDetail['model']->find_data('blog_category', 'row', ['id' => $row->blog_category]);
                                        ...
                                        <td>
                                            <?php if($row->image!='') { ?>
                                            <img src="<?=base_url('/uploads/blogs/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                            <?php } ?>                                        
                                        </td>
                                        <td>

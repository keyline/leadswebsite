                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="content_date" id="content_date" placeholder="Title" value="<?php echo $content_date; ?>" required="required">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                          <?php if($image!='') { ?>
                                          <img src="<?php echo base_url();?>/uploads/events/<?php echo $image; ?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                          <?php } ?>
                                        </div>

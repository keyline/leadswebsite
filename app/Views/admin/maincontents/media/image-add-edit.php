                        ...
                        <div class="row">
                            <!-- <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="partner_type">Category</label>
                                    <select class="js-example-basic-single form-control" id="partner_type" name="category" required="required">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="partner_logo">Media image</label>

                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Page Title 1</th>
                                    <th>Page Title 2</th>
                                    <th>Page Description 1</th>
                                    <th>Page Description 2</th>
                                    <th>Page Image</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo wordwrap($row->description2,30,"<br>\n"); ?></td>
                                    <td>
                                        <?php if($row->banner_image!='') { ?>
                                          <img src="<?=base_url('/uploads/testing-services/'.$row->banner_image)?>" class="img-responsive img-thumbnail" style="height:100px; width:200px;"  />
                                        <?php } ?>                                        
                                    </td>
                                    <td>

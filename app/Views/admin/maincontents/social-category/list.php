                    ...
                    <div class="dt-responsive table-responsive">
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th><?php echo $moduleDetail['module']; ?> Name</th>
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <!-- <a href="<?php echo base_url(); ?>/admin/<?php echo $moduleDetail['controller']; ?>/confirm_delete/<?php echo $row->$primary_key; ?>" class="btn  btn-icon btn-danger sweet-multiple" title="Delete"><i class="feather icon-trash"></i></a> -->

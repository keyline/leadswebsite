                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if(count($course_name)>0){
                                            echo '<ul>';
                                            for($r=0;$r<count($course_name);$r++){
                                                $course = $moduleDetail['model']->find_data(['name' => 'sms_courses'], 'row', ['id' => $course_name[$r]]);
                                                echo '<li>'.(!empty($course)?$course->course_name:'').' : '.$rank[$r].'</li>';
                                            }
                                            echo '</ul>';
                                        }
                                        ?>
                                    ...
                                    <td>
                                        <?php if($row->image!='') { ?>
                                          <img src="<?=base_url('/uploads/success_story/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                        <?php } ?>                                        
                                    </td>
                                    <td>

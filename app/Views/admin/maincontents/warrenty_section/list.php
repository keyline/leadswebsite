                        ...
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Warrenty Section Title</th>
                                    <th>Warrenty Section Icon</th>
                                    <!-- <th>Warrenty Section Description</th> -->
                                    <th>Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $row->warrenty_section_title; ?></td>                                    
                                    <td>
                                        <?php if($row->warrenty_section_icon!='') { ?>
                                          <img src="<?=base_url('/uploads/warrenty_section/'.$row->warrenty_section_icon)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                        <?php } ?>                                        
                                    </td>
                                    <!-- <td>?php echo $row->warrenty_section_description; ?></td> -->

                        ...
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo wordwrap($row->description,60,"<br>\n"); ?></td>
                                    <td>
                                        <?php if($row->image!='') { ?>
                                          <img src="<?=base_url('/uploads/director_desk/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                        <?php } ?>                                        
                                    </td>

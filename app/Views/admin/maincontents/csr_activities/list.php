                    ...
                    <div class="dt-responsive table-responsive">
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td><?php echo wordwrap($row->description,40,"<br>\n"); ?></td>
                                    <td>
                                        <?php if($row->image!='') { ?>
                                          <img src="<?=base_url('/uploads/csr_activities/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                        <?php } ?>                                        
                                    </td>
                                    <td><?php echo $row->activities_title; ?></td>
                                    <td>

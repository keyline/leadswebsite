                            ...
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row->prefered_location1; ?><br>
                                            <?php echo $row->prefered_location2; ?><br>
                                            <?php echo $row->prefered_job_location; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo base_url(); ?>/admin/<?php echo $moduleDetail['controller']; ?>/details/<?php echo $row->$primary_key; ?>" class="btn  btn-icon btn-primary" title="Edit"><i class="feather icon-eye"></i> View Details</a>                                        
                                        </td>
                                    </tr>                                    
                                    <?php } } ?>
                                </tbody>

                        ...
                        <div class="row">                            
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label" for="title">Project/Process Title</label>
                            ...
                            <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-2">
                                          ...
                                          <a href="<?= base_url();?>/uploads/projects_process/<?php echo $pdf; ?>" target="blank" class="fas fa-eye" style='color:green'> View pdf</a>
                                          <?php } ?>
                                        </div>

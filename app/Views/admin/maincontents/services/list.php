                        ...
                        <table id="simpletable" class="table table-striped table-bordered wrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        $product= $common_model->find_data('sms_product', 'row', ['id'=>$row->product_title]);
                                        if($product){
                                    ...
                                    <td>
                                        <?php if($row->services_image!='') { ?>
                                          <img src="<?=base_url('/uploads/services/'.$row->services_image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                        <?php } ?>                                        
                                    </td>

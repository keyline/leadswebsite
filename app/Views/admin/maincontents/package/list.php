                        ...
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            <thead>
                                <tr>
                                    ...
                                    <th>Package Name</th>
                                    <!-- <th>Feature Image</th> -->
                                    <th>Day/night <br> Person <br> Price</th>
                                    <!-- <th>Description3 Heading</th> -->
                                    <!-- <th>Description4 Heading</th> -->
                                    <!-- <th>Additional Images<br>Additional Images Titles</th> -->
                                    <!-- <th>Banner Image</th> -->
                                    <th>Country Name</th>
                                    <th>Action</th>
                                </tr>
                                ...
                                <?php if ($rows) {
                                    ...
                                    foreach ($rows as $row) { 
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row->day_night; ?><br><?= $row->person; ?><?= $row->package_price ?></td>
                                            <!-- <td><?= $row->description_heading; ?></td>
                                    <td><?= $row->description2_heading; ?></td> -->
                                            <!-- <td><?= $row->additional_images ?><br><?= $row->additional_images_titles; ?></td> -->

                            ...
                            <table id="simpletable" class="table table-striped table-bordered wrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $i++; ?></td>
                                        <td><?=$row->title?></td>
                                        <td><iframe width="250" height="200" src="https://www.youtube.com/embed/<?php echo $row->video_code ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></td>
                                        <td>

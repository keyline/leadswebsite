                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="dt-responsive table-responsive">
                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                <thead>
                                    <tr>
                                        <th class="admin-select-none" style="width: 129.188px;"><a href="javascript:selectToggle(selete);" id="show"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            $category          = $moduleDetail['model']->find_data('project_category', 'row', ['id' => $row->project_category]);
                                        ...
                                        <td>
                                            <?php if($row->image!='') { ?>
                                            <img src="<?=base_url('/uploads/projects/'.$row->image)?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;"  />
                                            <?php } else { ?> 
                                                <img src="<?=base_url('/uploads/projects/logo_no_image.png')?>" class="img-responsive img-thumbnail" style="height:100px; width:100px;border-radius: 50%;"  />
                                        <?php }  ?>                                       
                                        </td>
                                        <td>
                                            ...
                                            <?php } ?>
                                            <br><br>
                                            <a href="<?=base_url('admin/manage_project/image_list/'.$row->$primary_key)?>" class="btn btn-info btn-block"><i class="feather icon-image" aria-hidden="true"></i> Image Gallery</a>
                                        </td>
                                    </tr>                                    
                                    <?php } } ?>
                                </tbody>

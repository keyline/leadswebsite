                    ...
                    <div class="dt-responsive table-responsive">
                        <table id="simpletable" class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                <?php $country          = $moduleDetail['model']->find_data('sms_countries', 'row', ['id' => $row->country_id]); ?>
                                <tr>
                                    <td><?php echo $i++; ?></td>
                                    <td>
                                        <?php if($row->country_id!='') { ?>
                                          <img src="<?=base_url('/uploads/country/'.$country->flag)?>" class="img-responsive img-thumbnail" style="height:80px; width:150px;"  />
                                        <?php } ?>                                        
                                    </td>
                                    <td><?php echo (($country)?$country->name:''); ?></td>
                                    <td><?php echo wordwrap(($row)?$row->short_description:'',60,"<br>\n"); ?></td>
                                    <td>

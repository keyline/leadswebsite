...
<section class="inner_banner inner_floting_box_banner contact_us_banner">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tollfree_innerbox">
					<div class="tollfree_title text-center text-md-end">
						<a href="tel: 1800 212 1200"><img src="<?= base_url('public/') ?>/assets/img/toll-free.webp" alt="" style="width: 60px;filter: invert(41%) sepia(99%) saturate(3007%) hue-rotate(7deg) brightness(107%) contrast(107%);"> 1800 212 1200</a>
					</div>
				</div>												
			</div>
		</div>

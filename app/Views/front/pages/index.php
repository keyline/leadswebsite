                        ...
                        <ul class="nav nav-pills home_product_tab" id="pills-tab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                    ...
                                    aria-selected="true">Kitchen Chimney</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-profile" type="button" role="tab"
                                    aria-controls="pills-profile" aria-selected="false">RO Water Purifier</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-contact" type="button" role="tab"
                                    aria-controls="pills-contact" aria-selected="false">Cook Tops Hob Tops</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="pills-water-treatment-plant-tab" data-bs-toggle="pill"
                                    data-bs-target="#pills-water-treatment-plant" type="button" role="tab"
                                    aria-controls="pills-water-treatment-plant" aria-selected="false">Water Treatment
                                    Plant</button>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-12">
                    <div class="home_product_tab_content_box" data-aos="fade-down" data-aos-duration="1000">
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                ...
                                <div class="swiper productswiper">
                                    <div class="swiper-wrapper">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                                ...
                                                                <img src="<?= base_url('public/') ?>/assets/img/product1.webp" alt="" class="img-fluid">
                                                                <h4>EMBARK</h4>
                                                                <p>Air Flow : 1750 m3 / h</p>
                                                            </div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                                <img src="<?= base_url('public/') ?>/assets/img/product2.webp" alt="" class="img-fluid">
                                                                <h4>EMBARK</h4>
                                                                <p>Air Flow : 1750 m3 / h</p>
                                                            </div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                                <img src="<?= base_url('public/') ?>/assets/img/product3.webp" alt="" class="img-fluid">
                                                                <h4>EMBARK</h4>
                                                                <p>Air Flow : 1750 m3 / h</p>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="swiper-slide">
                                            <div class="product_item">
                                                <div class="swiper productimgswiper" id="mySwiperIdtwo">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                                <img src="<?= base_url('public/') ?>/assets/img/product2.webp" alt="" class="img-fluid">
                                                                <h4>tend</h4>
                                                                <p>Air Flow : 1500 m3 /h</p>
                                                            </div>
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                        ...
                                                        <div class="swiper-slide">
                                                            <div class="product_info">
                                                                <img src="<?= base_url('public/') ?>/assets/img/product4.webp" alt="" class="img-fluid">
                                                                <h4>tend</h4>
                                                                <p>Air Flow : 1500 m3 /h</p>
                                                            </div>
                                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-water-treatment-plant" role="tabpanel"
                                aria-labelledby="pills-water-treatment-plant-tab" tabindex="0">
                                <!-- Swiper -->
                                <div class="swiper productswiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">

                        ...
                        <div class="product_dtl_left">
                            ...
                            <div class="product_main_img">
                                ...
                                <div class="swiper-wrapper">                                    
                                    ...
                                    <?php if($product->isvideoupload == 'true' && $product->video_file != '') { ?>
                                    ...
                                    <?php } elseif(!empty($product->video_code)) { ?>
                                        <div class="swiper-slide d-flex align-items-center h-auto">
                                            <!-- <div class="product_info"> -->
                                                <iframe width="100%" src="https://www.youtube.com/embed/<?= $product->video_code ?>?autoplay=1&mute=1" 
                                    ...
                                    <div class="col-lg-8 product_thumb_mob col-md-12">
                                        <div thumbsSlider="" class="swiper mySwiper thumbsSlider">
                                            <div class="swiper-wrapper">                                                 
                                                ...
                                                <?php if($product->isvideoupload == 'true' && $product->video_file != '') { ?>
                                                    <div class="swiper-slide"> 
                                                        <div class="product_video_holder">
                                                ...
                                                <?php } elseif(!empty($product->video_code)) { ?>
                                                    <div class="swiper-slide"> 
                                                        <div class="product_video_holder">
                                                            <iframe width="100%" src="https://www.youtube.com/embed/<?= $product->video_code ?>" 
                                                                title="YouTube video player" frameborder="0" 
                                                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                                                                allowfullscreen>
                                                            </iframe> 
                        ...
                        <div class="product_details_right">
                            ...
                            <h2><?=$product->product_title; ?> <?php if($product->is_new == 1){ ?><span class="new_badge">New</span><?php }?> </h2>
                                <div class="offerprice_top">
                                    <h5>MRP <span class="spancolon" style="font-weight: normal;">:</span></h5>
                            ...
                            <div class="prod_garaty">                                
                                ...
                                <div class="gradt_icon">                                    
                                    <img src="<?= base_url('/uploads/warrenty_section/'.$warrentySection->warrenty_section_icon) ?>" alt="" class="img-fluid">
                                </div>     
                                <?php } }?>                                                                                                                                                                                                    
                            </div>
                        </div>
                                    ...
                                    <div class="product_item">
                                        ...
                                        <div class="swiper productimgswiper" id="mySwiperId">
                                            <div class="swiper-wrapper">
                                                ...
                                                <?php }  
                                                // Show video slide AFTER all images
                                                if($relatedProducts->isvideoupload == 'true' && $relatedProducts->video_file != '') { ?>
                                                    <div class="swiper-slide">    
                                                        <div class="product_info">                                                   
                                                            <video width="100%" autoplay muted loop controls>
                                                                <source src="<?= base_url('/uploads/product/' . $relatedProducts->video_file) ?>" type="video/mp4">
                                                            </video>  
                                                            <h4><?= $relatedProducts->product_title ?></h4>
                                                            <?php
                                                            $content_title        = json_decode($relatedProducts->content_title);
                                                ...
                                                <?php } elseif(!empty($relatedProducts->video_code)) { ?>
                                                    <div class="swiper-slide">         
                                                        <div class="product_info">                                              
                                                            <iframe width="100%" src="https://www.youtube.com/embed/<?= $relatedProducts->video_code ?>?autoplay=1&mute=1" 
                                                                title="YouTube video player" frameborder="0" 
                                                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" 
                                                                allowfullscreen>
                                                            </iframe>   
